...
class EmploymentsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create employment" do
    assert_difference("Employment.count") do
      post employments_url, params: { employment: { department_id: @employment.department_id, employee_id: @employment.employee_id, hire_date: @employment.hire_date, payroll_id: @employment.payroll_id, termination_date: @employment.termination_date } }
    end
  ...
  test "should update employment" do
    patch employment_url(@employment), params: { employment: { department_id: @employment.department_id, employee_id: @employment.employee_id, hire_date: @employment.hire_date, payroll_id: @employment.payroll_id, termination_date: @employment.termination_date } }
