...
class PayrollsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create payroll" do
    assert_difference("Payroll.count") do
      post payrolls_url, params: { payroll: { amount: @payroll.amount, cycle: @payroll.cycle } }
    end
  ...
  test "should update payroll" do
    patch payroll_url(@payroll), params: { payroll: { amount: @payroll.amount, cycle: @payroll.cycle } }
